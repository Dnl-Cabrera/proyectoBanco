...
class AdminModificarInternalUser extends React.Component {
    ...
    cambiarDatos = (e) => {
        ...
        if (e.target.name === "modificar") {
            ...
            this.usuarioPrueba.cargo = this.input_cargo.current.value;
    ...
    consultarDato = (e) => {
        ...
        if (this.input_id.current.value !== "") {
            ...
            this.input_cargo.current.value = this.usuarioPrueba.cargo;
        ...
        return (
            ...
            <div >
                    ...
                    <div className="col-sm-10">
                        <Form onSubmit={this.consultarDato}>
                            <Form.Group className="mb-3" controlId="formBasicEmail">
                                <Form.Label>Ingresa la cedula del usuario interno que deseas modificar o eliminar</Form.Label>
                ...
                <div className="row justify-content-center text-center d-none" ref={this.clase}>
                    <h1>Usuario interno consultado</h1>
                    <div className="col-sm-6 p-3">
                        ...
                        <TablaDatos titulo1="Cargo" titulo2="Rol" contenido1="cargo" contenido2="rol" referencia1={this.input_cargo} referencia2={this.input_rol} />
